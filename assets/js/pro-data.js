wpfront_add_filter( 'wpfront_form_settings', function (wpfront_form_settings) {
    ...
    wpfront_form_settings.form_settings.schema.fields = form_settings_schema.concat(wpfront_form_settings.form_settings.schema.fields);


    wpfront_form_settings.form_restriction.schema.fields.push({
        model: 'pro_1',
        type: 'input',
        inputType: 'checkbox',
    ...
    return wpfront_form_settings;
});

/**
 * Form fields
 */
wpfront_add_filter( 'wpfront_formFields', function ( formFields ) {
    var pro_formFields = [
//multiselect pro
        {
            pro: 1,
