var field_attr = {
    ...
    /*post*/
    //post_type,post_author,post_date,post_content,post_title,post_excerpt,post_status,comment_status,ping_status,post_password,post_name(slug),post_parent,
    post_type: {
        s: {
            name: 'post_type',
            label: 'Post Type',
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        visible: function (model) {
                            if ( model.type !== 'datetimerange' &&  model.type !== 'daterange' )
                                return true;
                            return false;
                        }
                    },
...
field_attr = wpfront_apply_filters( 'wpfront_field_attr', field_attr );
    ...
    if( fieldname !== 'common' ) {
        ...
        for( tabname in field_attr[fieldname].schema ) {
            ...
            if( typeof field_attr['common'].schema[tabname] !== 'undefined' ) {
                ...
                var common_fields = wpfront_reset_fields(field_attr['common'].schema[tabname].fields);
