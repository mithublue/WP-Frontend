<template id="promo_registration_form">
	<div>
		<?php
				...
				<el-col :sm="24" class="mb20">
					<el-card :body-style="{ padding: '0px' }">
						<div style="" class="text_center pt30 pb30 pr30 pl20">
							...
							<h5 class="mb20 mt20"><?php _e( 'To use contact form , you need add the extension, neoForms Pro ( Basic/Plus/Ultimate ).'); ?></h5>
...
It is designed to let you have the best and hassle free experience. '); ?></p>
								...
								<a class="el-button button-default" href="https://cybercraftit.com/neoforms-pro/" target="_blank"><?php _e( 'You can learn more about neoForms from here'); ?></a>
								<a class="el-button button-primary" href="https://cybercraftit.com/neoforms-pro/" target="_blank"><?php _e( 'Download', 'wpfront'); ?></a>
							</div>
						</div>
					</el-card>
				</el-col>
...
<script>
    var promo_registration_form = {
        template: '#promo_registration_form'
    }
</script>